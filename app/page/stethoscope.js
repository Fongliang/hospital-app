...
export default class stethoscope extends Component {
    open=()=>{
    ...
    return (
        <ScrollView>
            <List.Section title="掛號說明" titleStyle = {{fontSize:30}}>
                ...
                titleStyle = {{fontSize:20}}>
                    <List.Item title=" 大林：https://app.tzuchi.com.tw/tchw/OpdReg/SecList_DL.aspx" onPress={this.open} left={props => <List.Icon {...props} icon="link" />}/>
                    <List.Item title="斗六：https://app.tzuchi.com.tw/tchw/OpdReg/SecList_TL.aspx" onPress={this.open2} left={props => <List.Icon {...props} icon="link" />}/>
                </List.Accordion>
                <List.Accordion
                title="自動掛號機"
